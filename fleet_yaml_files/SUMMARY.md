...
Generated on: 2025-08-11 21:38:44 UTC

## Summary

Total casks processed: 457
...
- **File**: `1password-cli.yml`
- **URL**: https://cache.agilebits.com/dist/1P/op2/pkg/v2.31.1/op_darwin_arm64_v2.31.1.zip

### 1Password CLI (1password-cli@beta)

- **Version**: 2.31.1
- **Description**: Command-line helper for the 1Password password manager
- **File**: `1password-cli@beta.yml`
- **URL**: https://cache.agilebits.com/dist/1P/op2/pkg/v2.31.1/op_darwin_arm64_v2.31.1.zip
...
- **URL**: https://downloads.veertu.com/anka/Anka-3.7.3.204.pkg
...
- **Version**: 1.6.1
- **Description**: Install and configure AutoPkg
- **File**: `autopkgr.yml`
- **URL**: https://github.com/lindegroup/autopkgr/releases/download/v1.6.1/AutoPkgr-1.6.1.dmg
...
### Avid Codecs LE (avidcodecsle)

- **Version**: 2.7.6,3B39AE16
- **Description**: Use QuickTime movies using Avid codecs on systems without Media Composer
- **File**: `avidcodecsle.yml`
- **URL**: https://cdn.avid.com/Codecs/LE/2.7.6/3B39AE16/AvidCodecsLE_2.7.6_Mac.pkg.zip
...
- **File**: `basictex.yml`
- **URL**: https://mirror.ctan.org/systems/mac/mactex/mactex-basictex-20250308.pkg
...
- **File**: `bcut.yml`
- **URL**: https://boss.hdslb.com/bcut_pc_pkg/static/e66098dde9fd01dec3a670d099266608/BCUT-3.10.0-20160807-arm.dmg
...
### CloudNet for Mac client (cloudnet)

- **Version**: 1.36.2.22
- **Description**: Enterprise-level meshVPN cloud service
- **File**: `cloudnet.yml`
- **URL**: https://pkgs.cloudnet.world/stable/macos/CloudNet_v1.36.2.22.dmg
...
- **Version**: 1.2.4
- **Description**: Create packages to deploy user accounts
- **File**: `createuserpkg.yml`
- **URL**: https://magervalp.github.io/CreateUserPkg/Distributions/CreateUserPkg-1.2.4.dmg
...
- **Version**: latest
- **Description**: Chinese-German dictionary
- **File**: `dehelper.yml`
...
### .Net Runtime (dotnet-runtime@preview)

- **Version**: 9.0.8
- **Description**: Developer platform
- **File**: `dotnet-runtime@preview.yml`
- **URL**: https://builds.dotnet.microsoft.com/dotnet/Runtime/9.0.8/dotnet-runtime-9.0.8-osx-arm64.pkg
...
### .NET SDK (dotnet-sdk@preview)

- **Version**: 9.0.304
- **Description**: Developer platform
- **File**: `dotnet-sdk@preview.yml`
- **URL**: https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.304/dotnet-sdk-9.0.304-osx-arm64.pkg
...
- **Version**: 0.1.1
- **Description**: Federated Open Key Service; E2EE KV-store and Git hosting
- **File**: `foks.yml`
- **URL**: https://pkgs.foks.pub/stable/darwin/foks-v0.1.1-darwin-brew-arm64.zip
...
- **Version**: latest
- **Description**: 
- **File**: `font-noto-color-emoji.yml`
...
- **Version**: latest
- **Description**: 
- **File**: `font-noto-kufi-arabic.yml`
...
- **Version**: latest
- **Description**: 
- **File**: `font-noto-naskh-arabic.yml`
...
- **Version**: latest
- **Description**: 
- **File**: `font-noto-nastaliq-urdu.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoNastaliqUrdu-unhinted.zip

### Noto Sans Adlam (font-noto-sans-adlam)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-adlam.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansAdlam-unhinted.zip

### Noto Sans Adlam Unjoined (font-noto-sans-adlam-unjoined)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-adlam-unjoined.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansAdlamUnjoined-unhinted.zip

### Noto Sans Anatolian Hieroglyphs (font-noto-sans-anatolian-hieroglyphs)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-anatolian-hieroglyphs.yml`
...
- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-hebrew.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansHebrew-unhinted.zip

### Noto Sans Imperial Aramaic (font-noto-sans-imperial-aramaic)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-imperial-aramaic.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansImperialAramaic-unhinted.zip

### Noto Sans Inscriptional Pahlavi (font-noto-sans-inscriptional-pahlavi)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-inscriptional-pahlavi.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansInscriptionalPahlavi-unhinted.zip

### Noto Sans Inscriptional Parthian (font-noto-sans-inscriptional-parthian)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-inscriptional-parthian.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansInscriptionalParthian-unhinted.zip

### Noto Sans Javanese (font-noto-sans-javanese)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-javanese.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansJavanese-unhinted.zip

### Noto Sans Kaithi (font-noto-sans-kaithi)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-kaithi.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansKaithi-unhinted.zip

### Noto Sans Kannada (font-noto-sans-kannada)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-kannada.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansKannada-unhinted.zip

### Noto Sans Kayah Li (font-noto-sans-kayah-li)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-kayah-li.yml`
- **URL**: https://noto-website-2.storage.googleapis.com/pkgs/NotoSansKayahLi-unhinted.zip

### Noto Sans Kharoshthi (font-noto-sans-kharoshthi)

- **Version**: latest
- **Description**: 
- **File**: `font-noto-sans-kharoshthi.yml`
...
- **File**: `hwsensors.yml`
- **URL**: https://github.com/kozlekek/HWSensors/releases/download/6.26/HWSensors.6.26.1440.pkg.zip

### HY-RPE2 (hy-rpe2)

- **Version**: 1.2.9,2020
- **Description**: 8 track midi sequencer plugin
- **File**: `hy-rpe2.yml`
- **URL**: https://hy-plugins.com/wp-content/uploads/2020/HY-RPE2.pkg.zip
...
- **Version**: 2025.0308
- **Description**: Full TeX Live distribution with GUI applications
- **File**: `mactex.yml`
...
- **URL**: https://officecdnmac.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Excel_16.99.25072714_Installer.pkg
...
- **URL**: https://officecdnmac.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_OneNote_16.99.25071321_Updater.pkg
...
### Microsoft Build of OpenJDK (microsoft-openjdk@21)
...
- **URL**: https://officecdnmac.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.99.25071321_Installer.pkg
...
- **URL**: https://officecdnmac.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_PowerPoint_16.99.25072714_Installer.pkg
...
- **URL**: https://officecdnmac.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.99.25072714_Installer.pkg
...
- **Version**: 3.7.0
- **Description**: Security software for business
- **File**: `nordlayer.yml`
- **URL**: https://downloads.nordlayer.com/mac/latest/NordLayer_v3.7.0.pkg
...
### Obscura VPN (obscura-vpn)

- **Version**: 1.129
- **Description**: VPN client
- **File**: `obscura-vpn.yml`
- **URL**: https://pkgs.obscura.net/macos/obscura-1.129.dmg
...
- **File**: `ossapp.yml`
- **URL**: https://gui.pkgx.dev/release/ossapp-0.3.5-arm64-mac.zip
...
- **File**: `owncloud.yml`
- **URL**: https://download.owncloud.com/desktop/ownCloud/stable/5.3.2.15463/mac/ownCloud-5.3.2.15463-arm64.pkg
...
### PlasicSCM - a Cloud Edition (plasticscm-cloud-edition)

- **Version**: 11.0.16.9579
- **Description**: Install PlasticSCM locally and join a Cloud Edition subscription
- **File**: `plasticscm-cloud-edition.yml`
- **URL**: https://d26z97tczqnlef.cloudfront.net/releases/11.0.16.9579/plasticscm/osx/unity-vcs-11.0.16.9579-mac.pkg.zip
...
- **File**: `pritunl.yml`
- **URL**: https://github.com/pritunl/pritunl-client-electron/releases/download/1.3.4335.94/Pritunl.pkg.zip
...
- **File**: `programmer-dvorak.yml`
- **URL**: https://www.kaufmann.no/downloads/macos/ProgrammerDvorak-1_2_13.pkg.zip

### Prolific USB to Serial Cable driver (prolific-pl2303)

- **Version**: 2.2.5,20240808
- **Description**: PL2303 USB-to-serial driver
- **File**: `prolific-pl2303.yml`
- **URL**: https://www.prolific.com.tw/UserFiles/files/PL2303HXD_G_Mac%20Driver_v2_2_5_20240808_pkg.zip
...
- **Version**: 9.1.24
- **Description**: Simulator that runs MIPS32 assembly language programmes
- **File**: `qtspim.yml`
- **URL**: https://downloads.sourceforge.net/spimsimulator/QtSpim_9.1.24_mac.mpkg.zip
...
- **File**: `rekordbox.yml`
- **URL**: https://cdn.rekordbox.com/files/20250805161036/Install_rekordbox_7_1_5.pkg_.zip
...
### SteelSeries GG 91 (steelseries-gg)

- **Version**: 91.0.0
- **Description**: Settings for SteelSeries peripherals and accessories
- **File**: `steelseries-gg.yml`
- **URL**: https://engine.steelseriescdn.com/SteelSeriesGG91.0.0.pkg
...
- **File**: `trae.yml`
- **URL**: https://lf-cdn.trae.ai/obj/trae-ai-us/pkg/app/releases/stable/1.0.17305/darwin/Trae-darwin-arm64.dmg
...
- **Description**: Adaptive AI IDE
- **File**: `trae-cn.yml`
- **URL**: https://lf-cdn.trae.com.cn/obj/trae-com-cn/pkg/app/releases/stable/1.0.17303/darwin/Trae%20CN-darwin-arm64.dmg
...
- **Description**: Zero trust network access platform
- **File**: `twingate.yml`
- **URL**: https://binaries.twingate.com/client/macos/2025.175.15032/Twingate.pkg
...
- **File**: `uninstallpkg.yml`
- **URL**: https://www.corecode.io/downloads/uninstallpkg_1.2.2.zip
...
- **Version**: 7.5.1,8994
- **Description**: All-in-one office service platform in Chinese
- **File**: `wpsoffice-cn.yml`
- **URL**: https://package.mac.wpscdn.cn/mac_wps_pkg/7.5.1/WPS_Office_7.5.1(8994)_arm64.dmg
...
- **Description**: Video communication and virtual meeting platform
- **File**: `zoom.yml`
- **URL**: https://cdn.zoom.us/prod/6.5.9.61929/arm64/zoomusInstallerFull.pkg
